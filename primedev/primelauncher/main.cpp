...
static DWORD GetProcessByName(std::wstring processName)
{
...
static FARPROC GetLauncherMain()
{
...
static void AwaitOriginStartup()
{
	WSADATA wsaData;
...
int main(int argc, char* argv[])
{
...

	{
		...
		bool loadNorthstar = ShouldLoadNorthstar(true);
		if (loadNorthstar)
		{
