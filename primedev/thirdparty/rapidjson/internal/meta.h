...
namespace internal
{
	...
	template <typename CT, typename T> struct IsMoreConst : AndExpr<
...
#define RAPIDJSON_ENABLEIF(cond) typename ::RAPIDJSON_NAMESPACE::internal::EnableIf<RAPIDJSON_REMOVEFPTR_(cond)>::Type* = NULL

#define RAPIDJSON_DISABLEIF(cond) typename ::RAPIDJSON_NAMESPACE::internal::DisableIf<RAPIDJSON_REMOVEFPTR_(cond)>::Type* = NULL

#define RAPIDJSON_ENABLEIF_RETURN(cond, returntype)                                                                                        \
	typename ::RAPIDJSON_NAMESPACE::internal::EnableIf<RAPIDJSON_REMOVEFPTR_(cond), RAPIDJSON_REMOVEFPTR_(returntype)>::Type

#define RAPIDJSON_DISABLEIF_RETURN(cond, returntype)                                                                                       \
	typename ::RAPIDJSON_NAMESPACE::internal::DisableIf<RAPIDJSON_REMOVEFPTR_(cond), RAPIDJSON_REMOVEFPTR_(returntype)>::Type
