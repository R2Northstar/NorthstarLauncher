...
namespace spdlog
{
	...
	template <typename FormatString, typename... Args> inline void log(level::level_enum lvl, const FormatString& fmt, Args&&... args)
	{
	...
	template <typename T> inline void log(source_loc source, level::level_enum lvl, const T& msg)
	{
