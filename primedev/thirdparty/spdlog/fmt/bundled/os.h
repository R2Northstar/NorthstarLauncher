...
namespace detail
{
	...
	FMT_API void format_windows_error(buffer<char>& out, int error_code, string_view message) FMT_NOEXCEPT;
} // namespace detail
...
namespace detail
{
	...
	struct ostream_params
	{
		...
		template <typename... T> ostream_params(T... params, int oflag)
			: ostream_params(params...)
		{
			this->oflag = oflag;
		}

		template <typename... T> ostream_params(T... params, detail::buffer_size bs)
			: ostream_params(params...)
		{
...
public:
	...
	template <typename S, typename... Args> void print(const S& format_str, const Args&... args)
	{
 ...
 */
template <typename... T> inline ostream output_file(cstring_view path, T... params)
{
...
private:
	...
	static double strtod_l(const char* nptr, char** endptr, _locale_t loc) { return _strtod_l(nptr, endptr, loc); }
#endif
