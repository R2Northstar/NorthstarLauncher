...
namespace spdlog
{
	...
	template <typename It> inline details::dump_info<It> to_hex(const It range_begin, const It range_end, size_t size_per_line = 32)
	{
...
namespace fmt
{
	...
	template <typename T> struct formatter<spdlog::details::dump_info<T>>
	{
