...
#define ADD_SQFUNC(returnType, funcName, argTypes, helpText, runOnContext)                                                                 \
	...
	{                                                                                                                                      \
		__squirrelautobind CONCAT2(__squirrelautobind, __LINE__)(                                                                          \
			[]()                                                                                                                           \
			{                                                                                                                              \
				if constexpr ((runOnContext)&ScriptContext_UI)                                                                             \
					g_pSquirrel[ScriptContext_UI]->AddFuncRegistration(                                                                    \
						returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext_UI >);                 \
				if constexpr ((runOnContext)&ScriptContext_CLIENT)                                                                         \
					g_pSquirrel[ScriptContext_CLIENT]->AddFuncRegistration(                                                                \
						returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext_CLIENT >);             \
			},                                                                                                                             \
			[]()                                                                                                                           \
			{                                                                                                                              \
				if constexpr ((runOnContext)&ScriptContext_SERVER)                                                                         \
					g_pSquirrel[ScriptContext_SERVER]->AddFuncRegistration(                                                                \
						returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext_SERVER >);             \
			});                                                                                                                            \
	}                                                                                                                                      \
	template <ScriptContext context> SQRESULT CONCAT2(Script_, funcName)(HSQUIRRELVM sqvm)
...
#define REPLACE_SQFUNC(funcName, runOnContext)                                                                                             \
	...
	{                                                                                                                                      \
		__squirrelautobind CONCAT2(__squirrelautobind, __LINE__)(                                                                          \
			...
			{                                                                                                                              \
				if constexpr ((runOnContext)&ScriptContext_UI)                                                                             \
					g_pSquirrel[ScriptContext_UI]->AddFuncOverride(__STR(funcName), CONCAT2(Script_, funcName) < ScriptContext_UI >);      \
				if constexpr ((runOnContext)&ScriptContext_CLIENT)                                                                         \
					g_pSquirrel[ScriptContext_CLIENT]->AddFuncOverride(                                                                    \
						__STR(funcName), CONCAT2(Script_, funcName) < ScriptContext_CLIENT >);                                             \
			},                                                                                                                             \
			[]()                                                                                                                           \
			{                                                                                                                              \
				if constexpr ((runOnContext)&ScriptContext_SERVER)                                                                         \
					g_pSquirrel[ScriptContext_SERVER]->AddFuncOverride(                                                                    \
						__STR(funcName), CONCAT2(Script_, funcName) < ScriptContext_SERVER >);                                             \
			});                                                                                                                            \
	}                                                                                                                                      \
	template <ScriptContext context> SQRESULT CONCAT2(Script_, funcName)(HSQUIRRELVM sqvm)
