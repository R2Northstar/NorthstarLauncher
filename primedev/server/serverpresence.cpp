...
void ServerPresenceManager::CreateConVars()
{
	...
	Cvar_ns_server_name = new ConVar("ns_server_name", "Unnamed Northstar Server", FCVAR_GAMEDLL, "This server's name", false, 0, false, 0, []([[maybe_unused]] ConVar* cvar, [[maybe_unused]] const char* pOldValue, [[maybe_unused]] float flOldValue) {
	...
	Cvar_ns_server_desc = new ConVar("ns_server_desc", "Default server description", FCVAR_GAMEDLL, "This server's description", false, 0, false, 0, []([[maybe_unused]] ConVar* cvar, [[maybe_unused]] const char* pOldValue, [[maybe_unused]] float flOldValue) {
			g_pServerPresence->SetDescription(UnescapeUnicode(g_pServerPresence->Cvar_ns_server_desc->GetString()));
		});

	Cvar_ns_server_password = new ConVar("ns_server_password", "", FCVAR_GAMEDLL, "This server's password", false, 0, false, 0, []([[maybe_unused]] ConVar* cvar, [[maybe_unused]] const char* pOldValue, [[maybe_unused]] float flOldValue) {
