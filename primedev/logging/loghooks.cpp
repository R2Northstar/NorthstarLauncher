...
int,, ([[maybe_unused]] void* const stream, const char* const format, ...))
// clang-format on
{
	va_list va;
	va_start(va, format);
...
void, __fastcall, ([[maybe_unused]] void* pEngineServer, SpewType_t type, const char* format, va_list args))
// clang-format on
{
...
bool,, ([[maybe_unused]] void* thisptr, uintptr_t msg))
// clang-format on
{
