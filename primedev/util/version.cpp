...
void InitialiseVersion()
{
	...
	{
		sprintf_s(version, "%d.%d.%d.%d+dev", northstar_version[0], northstar_version[1], northstar_version[2], northstar_version[3]);
		ua_len += snprintf(
			NSUserAgent + ua_len,
	...
	{
		sprintf_s(version, "%d.%d.%d.%d", northstar_version[0], northstar_version[1], northstar_version[2], northstar_version[3]);
		ua_len += snprintf(
			NSUserAgent + ua_len,
			sizeof(NSUserAgent) - ua_len,
			"R2Northstar/%d.%d.%d",
