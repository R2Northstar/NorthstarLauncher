...
namespace sv_rcon
{
	...
	const std::string& response_t_Name(response_t value)
	{
		static const bool dummy = ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
			response_t_entries, response_t_entries_by_number, 6, response_t_strings);
		(void)dummy;
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
		::memset(
			reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&responseid_) - reinterpret_cast<char*>(this)),
			0,
			static_cast<size_t>(reinterpret_cast<char*>(&responsetype_) - reinterpret_cast<char*>(&responseid_)) + sizeof(responsetype_));
	}
	...
	void response::Clear()
	{
		...
		if (cached_has_bits & 0x0000000cu)
		{
			::memset(
				&responseid_,
				0,
				static_cast<size_t>(reinterpret_cast<char*>(&responsetype_) - reinterpret_cast<char*>(&responseid_)) +
					sizeof(responsetype_));
		}
		_has_bits_.Clear();
...
#undef CHK_
	...
	uint8_t* response::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
	{
		...
		if (_internal_has_responsebuf())
		{
			::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
				this->_internal_responsebuf().data(),
				static_cast<int>(this->_internal_responsebuf().length()),
		...
		{
			::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
				this->_internal_responseval().data(),
				static_cast<int>(this->_internal_responseval().length()),
				::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
	...
	void response::InternalSwap(response* other)
	{
		...
		::PROTOBUF_NAMESPACE_ID::internal::memswap<
			PROTOBUF_FIELD_OFFSET(response, responsetype_) + sizeof(response::responsetype_) -
