...
{
	// emit command can be used by everyone to spam, doesnt require sv_cheats or anythign. there's probably a better way to fix this but i
	// dont know it.
	...
	if (!_pCommand.find("emit ")) // space after emit cause thats needed to play a sound. no space before cause it could be a semicolon.
								  // this allows "emit" to still work, which doesnt do anything
	{
